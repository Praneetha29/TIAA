  ...
  return (
    <Box m="20px" display="flex" flexDirection="column">
      ...
      <Box display="flex">
        ...
        <Box display="flex" width="50%" height="35vh" >
          <Card sx={{ width: "60%", flex: 1, overflow: "auto", background: `${colors.primary[400]} !important`, marginTop: '20px' , marginLeft: '18px', height:'100%'  }}>
            <CardContent>
              <Strategist />
            </CardContent>
          </Card>
